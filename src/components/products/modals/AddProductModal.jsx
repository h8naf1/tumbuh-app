...
function AddProductModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-slate-950/80 p-4 backdrop-blur-sm md:p-8">
      <div className="flex max-h-[calc(100svh-2rem)] w-full max-w-2xl flex-col overflow-hidden rounded-3xl border border-slate-800 bg-slate-900 shadow-2xl shadow-black/40 md:max-h-[calc(100svh-4rem)]">
        ...
        <form onSubmit={onSubmit} className="flex min-h-0 flex-1 flex-col">
          ...
          <div className="shrink-0 border-t border-slate-800 bg-slate-900/72 px-6 py-4 backdrop-blur-xl supports-[backdrop-filter]:bg-slate-900/55">
