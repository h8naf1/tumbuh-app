    ...
    >
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="relative mx-auto w-full max-w-[440px] lg:max-w-[560px]">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-800 bg-[linear-gradient(160deg,rgba(15,23,42,0.92)_0%,rgba(2,6,23,0.98)_100%)] p-3 shadow-[0_30px_80px_-30px_rgba(2,6,23,0.75)] backdrop-blur-sm transition duration-500 hover:-translate-y-1 hover:shadow-[0_40px_90px_-36px_rgba(37,99,235,0.25)]">
